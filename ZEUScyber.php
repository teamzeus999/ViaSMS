#!/usr/bin/env php
#Dilarang copyright coded Zeus Cyber Official 2018 15 08 12:30
#Recode Mandul Anjg
<?php
...
echo $G."\n========[]Zeus Cyber Official SPAMER[]========".$X."\n";
echo  $YY. $B."\n::###############################################";
echo $R."\n::############[WELCOME:MY:HOME]##################";
echo $YY."\n::#:                                            #";
echo $BB."\n::#:Penutor  ::[Onyx7 ; Zeus Cyber Official]             #";
echo $B."\n::#:Website  ::[https:/zeuscyber.blogspot.com]#";
echo $RR."\n::#:Github   ::[http://github.com/teamzeus999:]  #";
echo $R."\n::#:Facebook ::[KEN : Onyx7]           #";
echo $G."\n::#:YouTube  ::[X-Play Termux:]                    #";
echo $GG."\n::#:Whatsapp ::[0852 1327 0579]                 #";
echo $YY."\n::#:                                            #";
...
if(is_numeric($argv[1])) {
	...
	while(1) {
		echo "[]Zeus Cyber Sending Massage To[] # ".$G.$argv[1].$X."\n";	
...
while(1) {
foreach($argv[1] as $argv[2]):
echo "[]Zeus Cyber Sending Massage To[] # ".$G.$argv[2].$X."\n";
